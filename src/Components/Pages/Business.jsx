  ...
  return (
    <div className="w-full">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&h=500&fit=crop")',
      ...
      >
        ...
        <div className="flex items-center gap-2 text-white text-sm md:text-base flex-wrap justify-center bg-black/30 px-4 py-2 rounded-full backdrop-blur-sm">
          ...
          <ChevronRight size={18} />
          <span className="text-orange-300 font-bold">Business Website Design</span>
        </div>
      </div>
